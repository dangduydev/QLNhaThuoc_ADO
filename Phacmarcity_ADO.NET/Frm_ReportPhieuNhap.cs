...
namespace Phacmarcity_ADO.NET
{
    public partial class Frm_ReportPhieuNhap : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'dsPhieuNhapReport.DataTable1' table. You can move, or remove it, as needed.
/*            this.dataTable1TableAdapter.Fill(this.dsPhieuNhapReport.DataTable1);*/
